layui.selMeltiple = function (a) {
  a(".layui-form select[multiple=multiple]").each(function (k, e) {
    ...
    a(this).find("option").each(function (h, b) {
      if (0 != h || null != a(this).attr("val") && "" !== a(this).attr("val")) {
        ...
        f += '<i style="display:inline-block;width:16px;height:16px;border:1px solid #e6e6e6;vertical-align:middle;margin-right:5px;line-height:19px;text-align:center;">'
            +
            (e ? "&radic;" : "") + "</i>";
        null != g && "" != g && (g = eval("(" + g + ")"), null != g.src && ""
        != g.src && (f += '<img src="' + g.src
            + '" height="16" width="16" style="margin-right:5px;vertical-align:middle;'
            + g.css + '"/>'));
        f += b;
        f += "</dd>";
        e && (d += "," + h, c += "," + b)
    ...
    a(this).before(
        '<input type="hidden" class="txtSel" name="' + a(this).attr("name")
        + '" value="' + d + '">');
    a(this).removeAttr("name");
    a(this).siblings("div.layui-form-select").find(
        ".layui-select-title input").val(c).attr("lay-verify",
        a(this).attr("lay-verify"));
    a(this).siblings("div.layui-form-select").find("dd").each(function (e, b) {
      a(this).click(function () {
        c = d = "";
        a(this).hasClass("layui-this") ? a(this).removeClass("layui-this").find(
            "i").text("") : a(this).addClass("layui-this").find("i").html(
            "&radic;");
        ...
        a(this).parent().siblings(".layui-select-title").find(
            "input.layui-input").val(c);
        var b = {};
...
layui.selImg = function (a, k) {
  ...
  a("" + k).each(function () {
    if ("multiple" != a(this).attr("multiple")) {
      ...
      null != e && 0 < e.length && ("" == a(e[0]).attr("value") || null == a(
          e[0]).attr("value")) && (f = 1);
      for (var d = a(this).siblings("div.layui-form-select").find("dd"), c = 0,
          h = d.length; c < h; c++) {
        var b = a(e[f]).attr("img");
        null != b && "" != b && (b = eval("(" + b + ")"), null != b.src && ""
        != b.src && a(d[c]).prepend('<img src="' + b.src
            + '" height="16" width="16" style="margin-right:5px;vertical-align:middle;'
            +
            b.css + '"/>'));
        f++
