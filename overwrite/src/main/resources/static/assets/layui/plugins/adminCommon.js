    ...
    function (e) {
      ...
      var adminCommon = {
        homePageTpl: function () {
          n("#main").find(".layui-tab-item").eq(0).load(
              _CTX + "/admin/home?v=" + (new Date).getTime())
        },
