 ...
 * </p>
 */
package org.qhn.stateless.threeGitHub.cache;
...
public class CacheDelegator {
    ...
    public int incPasswdRetryCount(String account) {
        Cache<String, Integer> cache = this.cacheManager
            .getCache(ShiroProperties.CACHE_NAME_PASSWORD_RETRY);
    ...
    public void cleanPasswdRetryCount(String account) {
        Cache<String, AtomicInteger> cache = this.cacheManager
            .getCache(ShiroProperties.CACHE_NAME_PASSWORD_RETRY);
    ...
    public String getKeepUser(String account) {
        Cache<String, String> cache = this.cacheManager
            .getCache(ShiroProperties.CACHE_NAME_KEEP_ONE_USER);
    ...
    public boolean cutBurnedToken(String token) {
        ...
        Cache<String, Integer> cache = this.cacheManager
            .getCache(ShiroProperties.CACHE_NAME_TOKEN_BURNERS);
