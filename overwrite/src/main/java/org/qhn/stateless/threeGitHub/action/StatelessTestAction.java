...
public class StatelessTestAction {
    ...
    BaseResponse hmacPost(
        ...
        try {
            String restPostUrl = request.getRequestURL().toString()
                .replace("stateless/hmac_post", "");
    ...
    BaseResponse hmacGet(
        ...
        try {
            String restGetUrl = request.getRequestURL().toString()
                .replace("stateless/hmac_get", "");
