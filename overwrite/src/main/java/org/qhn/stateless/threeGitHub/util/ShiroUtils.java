 ...
 * </p>
 */
package org.qhn.stateless.threeGitHub.util;
...
import org.qhn.stateless.threeGitHub.authc.StatelessLocals;
...
import org.qhn.stateless.threeGitHub.model.Account;
...
public class ShiroUtils {
     ...
     */
    public static String issueJwt(String subject, String issuer, Long period, String roles,
        String permissions, SignatureAlgorithm algorithm) {
        return CryptoUtil
            .issueJwt(shiroProperties.getJwtSecretKey(), subject, issuer, period, roles,
    ...
    public static List<Session> getActiveSessions() {
        return Collections.unmodifiableList(
            Lists.newArrayList(sessionManager.getSessionDAO().getActiveSessions()));
    }
