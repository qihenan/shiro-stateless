 ...
 * </p>
 */
package org.qhn.stateless.threeGitHub.token;
...
public class HmacToken extends StatelessToken {
    ...
    private String appId;// 客户标识（可以是用户名、app id等等））
    private String timestamp;// 时间戳
    private String baseString;// 待核验字符串
    private String digest;// 消息摘要

    public HmacToken(String host, String appId, String timestamp, String baseString,
        String digest) {
        super(host);
        this.appId = appId;
