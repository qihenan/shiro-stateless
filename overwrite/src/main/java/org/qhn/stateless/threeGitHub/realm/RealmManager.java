...
import org.qhn.stateless.threeGitHub.authc.JsetsHmacMatcher;
import org.qhn.stateless.threeGitHub.authc.JsetsJwtMatcher;
...
import org.qhn.stateless.threeGitHub.service.DefaultStatelessAccountProvider;
...
public class RealmManager {
    ...
    public void initRealms() {
        ...
        this.customRealms.forEach(realm -> {
            if (realm instanceof AuthorizingRealm) {
                ...
                if (authorizingRealm.isAuthenticationCachingEnabled() && this.properties
                    .isAuthCacheEnabled()) {
                    authorizingRealm
                        .setAuthenticationCacheName(ShiroProperties.CACHE_NAME_AUTHENTICATION);
                }
                if (authorizingRealm.isAuthorizationCachingEnabled() && this.properties
                    .isAuthCacheEnabled()) {
                    authorizingRealm
                        .setAuthorizationCacheName(ShiroProperties.CACHE_NAME_AUTHORIZATION);
                }
    ...
    public void setStatelessAccountProvider(
        ShiroStatelessAccountProvider statelessAccountProvider) {
