 ...
 * </p>
 */
package org.qhn.stateless.threeGitHub.config;
...
import org.qhn.stateless.threeGitHub.authc.JsetsModularRealmAuthenticator;
import org.qhn.stateless.threeGitHub.authc.JsetsPasswdMatcher;
import org.qhn.stateless.threeGitHub.authc.JsetsSubjectFactory;
import org.qhn.stateless.threeGitHub.cache.CacheDelegator;
import org.qhn.stateless.threeGitHub.cache.MapCacheManager;
import org.qhn.stateless.threeGitHub.cache.RedisCacheManager;
import org.qhn.stateless.threeGitHub.cache.SpringCacheManager;
import org.qhn.stateless.threeGitHub.filter.FilterManager;
import org.qhn.stateless.threeGitHub.handler.DefaultSessionListener;
import org.qhn.stateless.threeGitHub.realm.RealmManager;
...
public class JsetsShiroManager {
    ...
    private void buildRememberMeManager() {
        ...
        rememberMeManager
            .setCipherKey(CodecSupport.toBytes(this.properties.getRemembermeSecretKey()));
    ...
    private void buildCacheManager() {
        ...
        if (listableBeanFactory
            .getBeanNamesForType(org.springframework.cache.CacheManager.class).length > 0) {
            ...
            if (null != springCacheManager// EhCache
                ...
                ehCacheManager.setCacheManager(
                    ((org.springframework.cache.ehcache.EhCacheCacheManager) springCacheManager)
                        .getCacheManager());
            ...
            if (null != springCacheManager// Redis
                ...
                RedisConnectionFactory redisConnectionFactory = this.beanFactory
