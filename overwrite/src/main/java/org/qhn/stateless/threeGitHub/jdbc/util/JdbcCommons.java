 ...
 * </p>
 */
package org.qhn.stateless.threeGitHub.jdbc.util;
...
public abstract class JdbcCommons {
     ...
     * 方法调用
     */
    public static Object invokeMethod(Object object, Method method, String errorMsg,
        Object... args) {
        try {
     ...
     * 从结果集ResultSet中取值
     */
    public static Object getResultValue(ResultSet rs, int columnIndex, int jdbcType, Class<?> type)
        throws SQLException {
